...
Personalized Portfolio - Calculations of each category are made based on user's selected risk level; the difference and new amount are displayed as the result in corresponding columns. A message of recommanded transfers are displayed based on the calculation result.
